...
# things that I don't want to push public,
# work related...
if [ -f ~/.zshrc_specific ]; then
    source ~/.zshrc_specific
else
    print "~/.zshrc_specific not found."
fi
...
export PATH=$PATH:~/.local/go/go/bin:~/go/bin:~/.local
export PATH=$PATH:~/.local/share/code/VSCode-linux-x64/bin
